...
namespace HomeCinema.Web.Infrastructure.MessageHandlers
{
    ...
    {
        private IEnumerable<string> authHeaderValue = null;
            ...
            CancellationToken cancellationToken)
        {
            try
            {
                request.Headers.TryGetValues("Authorization", out authHeaderValue);
                ...
                var tokens = authHeaderValue.FirstOrDefault();

                tokens = tokens.Replace("Basic", null).Trim();
